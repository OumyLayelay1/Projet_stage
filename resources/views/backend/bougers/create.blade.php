            ...
            <div class="row backend-page-row">
                ...
                <div class="col-md-9 pt-4 backend-page-col">
                    ...
                    <div class="container-form">
                        ...
                        @endif
                        <form enctype="multipart/form-data" action="{{route('bougers.store')}}" method="POST">
                             @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="titre_bouger" class="form-control" id="titre_bouger" placeholder="">
                            </div>
                            <div class="mb-3">
                                <label for="description_bouger" class="form-label">Descriptions</label>
                                <input type="text" name="description_bouger" class="form-control" id="description_bouger" placeholder="">
                            </div>
                            <div class="mb-3">
